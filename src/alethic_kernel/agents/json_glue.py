...
class JsonGlueAgent:
    ...
    def run(self, seed: int, task_inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        refund_due = True
        confidence = 0.6 if charge.get("stale") else 0.9
        ...
        return {"beliefs": {"refund_due": refund_due, "confidence": confidence},
                "action": action, "tool_obs": {"charge": charge, "refund": refund}}
